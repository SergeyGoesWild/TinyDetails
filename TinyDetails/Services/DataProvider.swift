...
final class DataProvider {
    ...
    [PaintingObject(idPainting: UUID(),
                    ...
                    endDescription: "“Black Square” (1915) by Kazimir Malevich is a groundbreaking work of abstract art. Considered a cornerstone of the Suprematist movement, the painting features a black square on a white background, symbolizing a break from traditional representation and the beginning of pure artistic feeling. More than a painting, it stands as a visual manifesto of radical artistic change.",
     ...
     PaintingObject(idPainting: UUID(),
                    ...
                    endSubtitle: "Level Complete!",
                    endDescription: "“Lady with an Ermine” (1489) is a portrait by Leonardo da Vinci. The lady is Cecilia Gallerani, a young woman from the court of Milan, known for her wit and education. The white ermine she is holding is a symbol of purity, grace, and noble status. The painting is admired for its realistic detail and the quiet connection between the lady and the animal.",
                    areas: [ClickableArea(idArea: UUID(),
                                          hintText: "the lady",
     ...
     PaintingObject(idPainting: UUID(),
                    ...
                    creationDate: "1607",
                    endSubtitle: "Level Complete!",
                    endDescription: "“A Glass Compote with Peaches, Jasmine Flowers, Quinces and a Grasshopper” (1607) is a still life by Fede Galizia, considered one of the earliest examples of the genre in Italian painting. The painting features peaches with soft textures, fragrant jasmine flowers, and golden quinces arranged with care. A small grasshopper sits quietly nearby, adding a touch of life and surprise. Known for her precision and realism, Galizia treats each object with great attention, turning everyday items into something elegant and timeless.",
                    areas: [ClickableArea(idArea: UUID(),
                                          hintText: "peaches",
     ...
     PaintingObject(idPainting: UUID(),
                    ...
                    creationDate: "1889",
                    endSubtitle: "Level Complete!",
                    endDescription: "“The Starry Night” (1889) is a painting by Vincent van Gogh, during his time in Saint-Paul-de-Mausole asylum. It shows a vivid night sky filled with swirling stars and a bright crescent moon, painted with bold, expressive strokes. A large cypress tree that rises in the foreground is typical of southern France. Below, a quiet village rests. In fact, the church steeple in the painting resembles architecture more common in the Netherlands (where van Gogh was from), not Provence. So the village is more symbolic than accurate — it represents a peaceful town beneath a turbulent sky, rather than a real place he saw.",
                    areas: [ClickableArea(idArea: UUID(),
                                          hintText: "starry sky",
     ...
     PaintingObject(idPainting: UUID(),
                    ...
                    creationDate: "1903",
                    endSubtitle: "Level Complete!",
                    endDescription: "“Echo and Narcissus” (1903) is a painting by John William Waterhouse. It illustrates a moment from Greek mythology, where the nymph Echo sits quietly in the background, watching Narcissus mesmerized by his own reflection in the still water. Echo, pale and fading, symbolizes unrequited love and sorrow. Around them grow delicate white narcissi flowers, a reference to the myth and to Narcissus’s eventual transformation. On the left side of the scene, a set of arrows lies abandoned on the ground, hinting at past action and now-forgotten pursuits. The arrows are a subtle visual metaphor: symbols of movement and life, now idle and useless, much like Echo herself, who has also been reduced to a shadow of what she once was.",
                    areas: [ClickableArea(idArea: UUID(),
                                          hintText: "Narcissus",
